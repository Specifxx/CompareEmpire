...
export const metadata = {
  title: "Suggest a store — OPCompare",
  description: "Know a One Piece Card Game store OPCompare should be comparing? Suggest it and we'll add it to the price comparison.",
  alternates: { canonical: "/stores/suggest" },
};

export default function SuggestStorePage() {
  const subject = encodeURIComponent("Store suggestion for OPCompare");
  const body = encodeURIComponent(
    "Store name:\nWebsite URL:\nMarket (AU/US/UK):\nWhy should OPCompare add it?\n"
  );
      ...
      <div className="card-surface overflow-hidden">
        <div className="relative border-l-2 border-brand-500 bg-ink-850 px-6 py-10 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-300">
            Know a One Piece Card Game store we&apos;re missing? Tell us who they are and we&apos;ll look at
