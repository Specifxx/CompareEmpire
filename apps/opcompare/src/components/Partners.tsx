...
// Trust strip: the partner programs OPCompare is APPROVED for — shown as a
...
export function Partners({ country }: { country: string }) {
  const ebayHref = ebaySearchUrl("one piece cards", country);
  const tcgHref = affiliateUrl("https://www.tcgplayer.com/search/one-piece-card-game/product");
  return (
