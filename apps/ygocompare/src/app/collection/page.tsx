...
export const metadata: Metadata = {
  title: "My Collection — track your Yu-Gi-Oh! cards & portfolio value",
  description:
    "Track the Yu-Gi-Oh! cards you own, see your collection's live market value across stores, and watch your set completion grow.",
