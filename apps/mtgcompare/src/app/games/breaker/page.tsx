...
export const metadata: Metadata = {
  title: "Bulk Breaker — breakout with real Magic cards",
  description:
    "Breakout where the bricks are real Magic cards — smash them to bank their live market value, catch multi-ball and wide-paddle power-ups, and clear levels of fresh cards.",
