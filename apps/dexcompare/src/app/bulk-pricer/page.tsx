...
export const metadata: Metadata = {
  title: "Bulk Pokémon Card Pricer — Price Hundreds of Cards at Once | DexCompare",
  description:
    "Paste or upload a list of Pokémon card names and get the cheapest live buy price and TCGplayer sell guide for every one — built for bulk and collection valuations, export to CSV.",
  alternates: { canonical: "/bulk-pricer" },
  openGraph: { title: "Bulk Pokémon Card Pricer", url: `${SITE_URL}/bulk-pricer` },
};
