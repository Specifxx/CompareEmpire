...
export const metadata: Metadata = {
  title: "My Collection — track your One Piece portfolio value & profit/loss",
  description:
    "Track the One Piece cards you own, value your collection live across stores, see profit/loss against what you paid, chart your value over time, and import your collection by CSV.",
