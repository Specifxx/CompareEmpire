...
export const metadata: Metadata = {
  title: "phone Buy & Sell Forum — PhoneCompare",
  description:
    "Community board for phones players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
