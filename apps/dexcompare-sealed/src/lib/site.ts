...
export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || "https://dexcompare.com").replace(/\/+$/, "");
export const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || "hello@dexcompare.com";
