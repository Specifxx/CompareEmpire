...
export const metadata: Metadata = {
  title: "Price Duel — Higher or Lower Magic Card Game",
  description:
    "Is the mystery Magic card worth more or less? Guess higher or lower against real TCGplayer market values and see how long your streak lasts. Free, no signup.",
