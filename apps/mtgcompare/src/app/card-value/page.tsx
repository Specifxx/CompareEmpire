...
// "magic card value" / "how much are my pokemon cards worth" / "price
...
export const metadata: Metadata = {
  title: "Magic Card Value Checker — Free Price Guide (2026)",
  description:
    "Check what your Magic cards are worth, free: search any card to see its live market value plus real store prices in Australia, New Zealand, the US and the UK. Vintage Base Set to the newest Mega Evolution chases — updated daily.",
  keywords: [
    "magic card value",
    "magic card value checker",
    "how much are my pokemon cards worth",
    "magic card price checker",
    "magic card worth",
    "magic card price guide",
  ],
...
const FAQS = [
  ...
  {
    q: "What makes a Magic card valuable?",
  ...
  {
    q: "Is this Magic card value checker free?",
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">Magic card value — FAQ</h2>
