      ...
      <div className="mt-6 space-y-6 border-t border-ink-800 pt-6 text-sm leading-relaxed text-slate-300">
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              <strong className="text-white">Email address</strong> — only if you opt in to
              wishlist price-drop alerts. Used solely to send those alerts; every email
              includes a one-click unsubscribe link that deletes your alerts.
            </li>
            <li>
        ...
        <section className="space-y-2">
          ...
          <p>
            We use cookies and similar technologies to remember preferences (such as your selected
            country and your wishlist), measure traffic, and serve advertising. You can disable
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            above, unsubscribe from price-drop emails with the link in any alert email, and request
            access to or deletion of your data by emailing us. Children under 13 (or the minimum
            age in your country) should not use the Site.
          </p>
        </section>
