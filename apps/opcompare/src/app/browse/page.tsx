...
export function generateMetadata({ searchParams }: { searchParams: CardQuery }): Metadata {
  ...
  return {
    title: "Browse the One Piece card database",
    description:
      "Search and filter every One Piece Card Game card and compare live prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
