...
export const SUBSIDIARIES: Subsidiary[] = [
  ...
  },
  {
    key: "mtgcompare",
    name: "MTGCompare",
    vertical: "Magic: The Gathering",
    tagline: "Every Magic: The Gathering single & sealed product, priced across TCGplayer, eBay & specialist stores.",
  ...
  },
  {
    key: "opcompare",
    name: "OPCompare",
    vertical: "One Piece Card Game",
    tagline: "Compare live One Piece Card Game singles & sealed prices across TCGplayer, eBay & specialist stores.",
  ...
  },
  {
    ...
    name: "YGOCompare",
    vertical: "Yu-Gi-Oh!",
    tagline: "Every Yu-Gi-Oh! single & sealed product, priced across TCGplayer, eBay & specialist stores.",
