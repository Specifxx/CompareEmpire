// Dexdle — the free "guess the One Piece card" game (OPCompare's Riftle).
...
// Rarity ladder for higher/lower hints. One Piece rarities aren't perfectly
...
// Pool: real One Piece (not Trainers/Energies), base prints with art and a REAL
...
// real-One Piece, priced, name-deduped pool so every game feels consistent.
