...
export const metadata: Metadata = {
  title: "Magic card deals — biggest discounts vs market price",
  description:
    "Magic singles selling well below their TCGplayer market price right now, across stores in Australia, New Zealand, the US and the UK. Updated daily — the fastest way to snipe underpriced cards.",
    ...
    <div className="flex flex-col gap-6">
      <section className="card-surface overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-8">
          <h1 className="text-2xl font-extrabold text-white sm:text-3xl">🔥 Today&apos;s best Magic deals</h1>
