...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "pokemon selling fee calculator",
    "should i grade my pokemon card",
  ],
  openGraph: {
    title: "Free Pokémon TCG Tools & Calculators",
...
const GROUPS: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      },
      {
        href: "/tools/box-ev",
        icon: "📦",
        title: "Booster box EV calculator",
        desc: "Is it worth opening a box? Estimated value from pull rates and today's card prices, per set.",
        badge: "New",
      },
      {
        href: "/bulk-pricer",
...
export default function ToolsHubPage() {
  const itemListLd = {
    ...
    "@type": "ItemList",
    name: "DexCompare Tools & Calculators",
    url: `${SITE_URL}/tools`,
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400">
        Every DexCompare tool in one place — all free, no sign-up. Price-check a card, see what you&apos;d
