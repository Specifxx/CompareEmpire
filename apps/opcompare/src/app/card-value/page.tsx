...
// "one piece card value" / "how much are my pokemon cards worth" / "price
...
export const metadata: Metadata = {
  title: "One Piece Card Value Checker — Free Price Guide (2026)",
  description:
    "Check what your One Piece cards are worth, free: search any card to see its live market value plus real store prices in Australia, New Zealand, the US and the UK. Vintage Base Set to the newest Mega Evolution chases — updated daily.",
  keywords: [
    "one piece card value",
    "one piece card value checker",
    "how much are my pokemon cards worth",
    "one piece card price checker",
    "one piece card worth",
    "one piece card price guide",
  ],
...
const FAQS = [
  ...
  {
    q: "What makes a One Piece card valuable?",
  ...
  {
    q: "Is this One Piece card value checker free?",
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">One Piece card value — FAQ</h2>
