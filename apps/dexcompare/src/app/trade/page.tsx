...
export const metadata: Metadata = {
  ...
  description:
    "Trading Pokémon cards in person? Add each side's cards and instantly compare their total value using DexCompare's live lowest prices — so you know a trade is fair before you shake on it.",
    ...
    <div className="mx-auto max-w-4xl">
      ...
      <header className="mb-5">
        ...
        <p className="mt-1 text-slate-400">
          ...
          value at a glance — using DexCompare&apos;s live lowest prices — and trade with confidence.
        </p>
      </header>
      <TradeCalculator />
    </div>
