      ...
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Buy, sell and talk One Piece with other players in {myCountryName}. List several cards in one
      ...
      {showForm && (
        <form onSubmit={submit} className="card-surface mb-6 space-y-3 p-4">
          ...
          <input
            value={form.title}
            onChange={set("title")}
            placeholder={isDiscussion ? "Title (required) — e.g. Best budget Luffy deck?" : "Title (required) — e.g. Selling my OP-01 doubles"}
            className="input"
            required
          />
