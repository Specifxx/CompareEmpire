...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      "What DexCompare is, why we built it, and how it helps Australian Pokémon players find the cheapest cards.",
    author: "DexCompare",
    date: "2026-06-06",
    readMins: 2,
    tags: ["news", "about"],
    body: `DexCompare is a free price-comparison tool for **the Pokémon Trading Card Game**, built for Australian players.

Pokémon is exciting, but tracking down the cheapest copy of a card across a dozen different stores is tedious — every shop prices differently, stock changes daily, and overseas sites quietly show you the wrong currency. We built DexCompare to do that legwork for you.

## What you can do here

- **[Browse the card database](/browse)** — every Pokémon card, with the lowest live price across Australian stores.
...
We're just getting started — the database, decks and price coverage grow every day. Spotted something off, or want a store added? Use the [contact form](/contact) or the [forum](/forum). Thanks for stopping by, and happy hunting.`,
  },
  {
    ...
    category: "blog",
    title: "Pokémon Unleashed Meta Snapshot — June 2026",
    excerpt:
...
Decklists are sourced from riftDecks.com and refresh with the metagame — we'll post a new snapshot as the meta shifts.`,
  },
  {
    ...
    category: "guide",
    title: "How a Pokémon Deck Is Built",
    excerpt:
      "Legend, Champion, main deck, runes, battlefields and sideboard — the anatomy of a Pokémon deck, explained with real examples.",
    author: "DexCompare",
    date: "2026-06-06",
    readMins: 4,
    tags: ["beginner", "deckbuilding"],
    body: `New to Pokémon deckbuilding? A constructed deck is made of a few distinct parts. Here's how the current tournament lists are put together.
...
Pokémon has seven domains — **Fury, Calm, Mind, Body, Chaos, Order** and **Colorless**. Most competitive decks commit to **one or two** domains (for example *Master Yi* is Body/Calm, while *Irelia* is Calm/Chaos). Your 12 runes are split to match those domains, which is how you reliably cast your cards.
