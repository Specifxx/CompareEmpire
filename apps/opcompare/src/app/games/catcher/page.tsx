...
export const metadata: Metadata = {
  title: "Card Catcher — the One Piece card arcade game",
  description:
    "Catch falling One Piece cards and bank their real market value — dodge the fakes, ride the combo, grab gold ×2 and slow-mo power-ups. A free arcade game built on live card prices.",
