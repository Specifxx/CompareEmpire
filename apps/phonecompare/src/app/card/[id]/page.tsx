...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  const description = `Compare live ${info.adjective} prices for ${card.name}, phone ${card.setName} ${card.collectorNumber}${price}. Find the cheapest store to buy this card in ${info.place}.`;
