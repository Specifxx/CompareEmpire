...
export const metadata = {
  title: "Contact & Feedback — CameraCompare",
  description: "Get in touch with CameraCompare — report a price issue, suggest a store to add, or send feedback.",
    ...
    <div className="mx-auto max-w-xl">
      <div className="card-surface overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-10 text-center">
          ...
          <a
            href={`mailto:${CONTACT_EMAIL}?subject=CameraCompare%20feedback`}
