...
export const metadata: Metadata = {
  title: "Minigames — free Magic card games",
  description:
    "Free Magic: The Gathering minigames powered by real card data: Price Duel (higher or lower) and the Pack Rip simulator. No signup, play instantly.",
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <header className="mb-6 text-center">
        <h1 className="font-display text-3xl font-extrabold text-white">🕹️ MTGCompare Arcade</h1>
