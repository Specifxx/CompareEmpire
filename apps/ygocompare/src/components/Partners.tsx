...
// Trust strip: the partner programs YGOCompare is APPROVED for — shown as a
...
export function Partners({ country }: { country: string }) {
  const ebayHref = ebaySearchUrl("yugioh cards", country);
  const tcgHref = affiliateUrl("https://www.tcgplayer.com/search/yugioh/product");
  return (
