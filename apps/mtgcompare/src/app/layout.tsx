...
export const metadata: Metadata = {
  ...
  title: {
    default: "MTGCompare — Magic: The Gathering Card Database & Price Comparison",
    template: "%s — MTGCompare",
  },
  description:
    "The Magic: The Gathering card database and price comparison. Browse cards and compare live prices across stores in Australia, New Zealand, the United States and the United Kingdom to find the cheapest place to buy MTG singles.",
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    url: SITE_URL,
    title: "MTGCompare — Magic: The Gathering Card Database & Price Comparison",
    description:
      "Compare live Magic: The Gathering card prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
  },
    ...
    <html lang="en-AU" className={`${sora.variable} ${spaceGrotesk.variable}`}>
      ...
      <body className="min-h-screen bg-ink-950">
        ...
        <footer className="container-app border-t border-ink-800 py-8 text-center text-xs text-slate-500">
          ...
          <NewsletterSignup siteName="MTGCompare" />
          ...
          <p>
            MTGCompare · Magic: The Gathering card database &amp; price comparison for
            ...
            site. Not affiliated with or endorsed by Wizards of the Coast or Hasbro.
