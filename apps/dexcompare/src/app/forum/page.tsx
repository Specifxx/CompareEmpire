...
export const metadata: Metadata = {
  title: "Pokémon Buy & Sell Forum — DexCompare",
  description:
    "Community board for Pokémon TCG players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
