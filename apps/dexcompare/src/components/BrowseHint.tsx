...
export function BrowseHint() {
  ...
  return (
    <div className="reveal in-view mb-4 flex items-center gap-3 rounded-xl border border-brand-500/30 bg-gradient-to-r from-brand-600/10 to-gold/10 px-4 py-3 text-sm">
      ...
      <button
        ...
        className="shrink-0 rounded-lg px-2 py-1 text-xs font-semibold text-slate-400 outline-none transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-brand-400"
