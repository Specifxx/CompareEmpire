    ...
    <div className="mx-auto max-w-md py-10">
      <div className="card-surface p-6">
        ...
        <p className="mt-1 text-sm text-slate-400">
          {isRegister
            ? "Create a free account to save your wishlist, track price drops and more."
            : "Sign in to sync your wishlist and manage your account."}
        </p>
        ...
        <form onSubmit={submit} className="flex flex-col gap-3">
          {isRegister && (
            <label className="block">
              ...
              <input className="input" value={displayName} onChange={(e) => setDisplayName(e.target.value)} placeholder="e.g. PlaneswalkerPro" autoComplete="nickname" required />
            </label>
          )}
          <label className="block">
