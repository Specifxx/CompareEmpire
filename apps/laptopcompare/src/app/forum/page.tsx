...
export const metadata: Metadata = {
  title: "laptop Buy & Sell Forum — LaptopCompare",
  description:
    "Community board for laptops players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
