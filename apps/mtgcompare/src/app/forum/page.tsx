...
export const metadata: Metadata = {
  title: `Magic: The Gathering Buy & Sell Forum — ${SITE_NAME}`,
  description:
    "Community board for Magic: The Gathering players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
