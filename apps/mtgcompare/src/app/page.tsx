...
export const metadata: Metadata = {
  title: { absolute: "Buy & Compare Magic: The Gathering Card Prices | MTGCompare" },
  description:
    "Compare live Magic: The Gathering card prices across stores in Australia, New Zealand, the United States and the United Kingdom, and find the cheapest place to buy MTG singles. Updated daily.",
  keywords: [
    "buy MTG cards",
    "MTG prices",
    "Magic card value",
...
function faqsFor(info: CountryInfo, ebay: string | null): { q: string; a: string }[] {
  ...
  return [
    {
      q: `Where can I buy Magic cards in ${place}?`,
      a: `MTGCompare compares live MTG prices across a wide range of ${adjective} stores${ebay ? ` plus ${ebay}` : ""}, so you can buy Magic: The Gathering singles from whichever shop is cheapest. Search any card to see every store's price and click straight through to buy.`,
    },
    {
      q: `How do I find the cheapest MTG prices in ${place}?`,
      a: `Search or browse the card database and each card shows the lowest live price across ${adjective} stores, ranked by total delivered cost (item plus shipping). It's the fastest way to find the cheapest Magic cards in ${place}.`,
    },
    {
      q: "What does MTGCompare track?",
      a: `MTGCompare covers a growing database of Magic: The Gathering singles — from Alpha Power Nine to the newest Standard set — each priced live across ${adjective} retailers so you can always find the cheapest place to buy.`,
    },
    {
      q: "How much are my Magic cards worth?",
      a: `Use the free MTG card value checker: search any card by name and set to see its live market value plus real ${adjective} store prices, updated daily — from 1993 Black Lotus to the latest mythics.`,
    },
    {
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface animate-fade-up overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-12 text-center">
          ...
          <h1 className="mx-auto max-w-3xl text-2xl font-extrabold text-white sm:text-4xl">
            Compare Magic: The Gathering card prices across {info.adjective} stores
          </h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-400 sm:text-base">
            Find the cheapest place to buy MTG singles in {info.place} — live prices in{" "}
      ...
      <section>
        <div className="mb-4 flex items-end justify-between gap-3">
          <div>
            <h2 className="text-xl font-extrabold text-white">Cheapest Magic cards</h2>
            <p className="mt-0.5 text-xs text-slate-500">
      ...
      <section>
        <div className="mb-4 flex items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-500">
              The biggest chase cards by market value — Power Nine, dual lands, format staples and more.
            </p>
          </div>
        ...
        <section>
          <div className="mb-4 flex items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-500">
                The cards collectors are checking most on MTGCompare.
              </p>
            </div>
          </div>
          <div className="-mx-1 flex gap-4 overflow-x-auto px-1 pb-2">
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">Magic prices in {info.place}, all in one place</h2>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-400">
          MTGCompare is a free, independent price-comparison tool for Magic: The Gathering, built for {info.adjective} players and collectors. We track live prices for MTG singles across
          {" "}{info.adjective} stores{ebay ? ` and ${ebay}` : ""} so you can buy Magic cards in {info.place} for
