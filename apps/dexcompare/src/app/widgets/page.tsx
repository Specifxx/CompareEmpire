...
export const metadata: Metadata = {
  title: "Free Pokémon Price Widget — Embed Live Card Prices",
  description:
    "Add a free, auto-updating Pokémon card price badge to your website, blog, store or Discord. It always shows the cheapest live price across stores and links back to the full comparison.",
  alternates: { canonical: "/widgets" },
  openGraph: {
    title: "Free Pokémon Card Price Widget",
    description:
      "Embed a live, auto-updating Pokémon card price on any site. Always shows the cheapest price across stores.",
      ...
      <section className="card-surface overflow-hidden">
        <div className="rounded-lg bg-gradient-to-br from-brand-600/20 via-ink-850 to-gold/10 px-6 py-12 text-center">
          ...
          <h1 className="mx-auto max-w-2xl text-2xl font-extrabold text-white sm:text-4xl">
            Embed a live Pokémon card price on your site
          </h1>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is the Pokémon price widget free?",
                acceptedAnswer: {
                  "@type": "Answer",
