// Dexdle — the free "guess the Yu-Gi-Oh! card" game (YGOCompare's Riftle).
...
// Rarity ladder for higher/lower hints. Yu-Gi-Oh! rarities aren't perfectly
...
// Pool: real Yu-Gi-Oh! (not Trainers/Energies), base prints with art and a REAL
...
// real-Yu-Gi-Oh!, priced, name-deduped pool so every game feels consistent.
