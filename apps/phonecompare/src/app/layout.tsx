...
export const metadata: Metadata = {
  ...
  title: {
    default: "PhoneCompare — Phone Database & Price Comparison",
    template: "%s — PhoneCompare",
  },
  description:
    "The phone database and price comparison. Browse phones and compare live prices across stores in Australia, the United States and the United Kingdom to find the cheapest place to buy.",
  applicationName: SITE_NAME,
  keywords: ["phone", "phones", "phone prices", "mirrorless phone", "DSLR", "buy phone"],
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    siteName: SITE_NAME,
    url: SITE_URL,
    title: "PhoneCompare — Phone Database & Price Comparison",
    description:
      "Compare live phone prices across stores in Australia, the US and the UK to find the cheapest place to buy.",
  },
  ...
  "@graph": [
    {
      ...
      "@id": `${SITE_URL}/#org`,
      name: SITE_NAME,
      alternateName: ["Phone Compare", "PhoneCompare.com"],
      url: SITE_URL,
      logo: `${SITE_URL}/icon-512.png`,
      description:
        "Phone database and live price-comparison across Australia, the US and the UK.",
    },
    {
      "@type": "WebSite",
      "@id": `${SITE_URL}/#website`,
    ...
    <html lang="en-AU" className={`${sora.variable} ${spaceGrotesk.variable}`}>
      ...
      <body className="min-h-screen bg-ink-950">
        ...
        <footer className="container-app border-t border-ink-800 py-8 text-center text-xs text-slate-500">
          ...
          <p>
            PhoneCompare · phone database &amp; price comparison for
