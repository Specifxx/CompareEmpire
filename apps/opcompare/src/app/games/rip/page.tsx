...
export const metadata: Metadata = {
  title: "Pack Rip Simulator — Open One Piece Packs for Free",
  description:
    "Rip simulated 10-card One Piece Card Game packs from recent sets, flip each card to reveal real market values, and see if your pack beats the typical pack price. Free, no signup.",
