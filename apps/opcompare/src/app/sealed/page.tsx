...
export function generateMetadata({ searchParams }: { searchParams: { q?: string; type?: string } }): Metadata {
  ...
  return {
    title: "One Piece booster packs, boxes & ETBs — compare sealed prices",
    description:
      "Browse the full One Piece sealed-product database — booster packs, booster boxes, elite trainer boxes, bundles, collection boxes and tins — and compare live prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="card-surface overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-8">
          <h1 className="text-2xl font-extrabold text-white sm:text-3xl">One Piece sealed products</h1>
      ...
      <p className="text-center text-[11px] text-slate-600">
        ...
        retailer&apos;s site. OPCompare may earn a commission on some outbound links.
      </p>
    </div>
  );
}
