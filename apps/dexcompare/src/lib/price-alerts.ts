...
//
// The compared price is the card's lowest BUYABLE store price (the market guide is
// excluded from lowest-price recomputes), so an alert always points at a real deal.
