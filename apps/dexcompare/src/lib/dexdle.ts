// Dexdle — the free "guess the Pokémon card" game (DexCompare's Riftle).
...
// Rarity ladder for higher/lower hints. Pokémon rarities aren't perfectly
...
// real-Pokémon, priced, name-deduped pool so every game feels consistent.
