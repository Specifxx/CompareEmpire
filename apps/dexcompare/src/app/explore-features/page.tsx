...
const GROUPS: Group[] = [
  {
    ...
    features: [
      { href: "/browse", icon: "🃏", title: "Card database", desc: "Search and filter every tracked Pokémon card with live prices." },
  ...
  },
  {
    ...
    features: [
      ...
      { href: "/pokemon/charizard", icon: "🔥", title: "Species price guides", desc: "Every printing of a Pokémon, one price guide — e.g. Charizard." },
      { href: "/trending", icon: "🔮", title: "Trending cards", desc: "What's being searched most right now." },
      { href: "/most-valuable", icon: "💎", title: "Most valuable cards", desc: "The priciest cards we track." },
    ],
  },
  {
    label: "Market data",
  ...
  },
  {
    ...
    features: [
      { href: "/learn", icon: "🎓", title: "Learn Pokémon TCG collecting", desc: "A structured beginner's path through the essentials." },
      ...
      { href: "/forum", icon: "💬", title: "Community forum", desc: "Buy/sell/discuss with other collectors." },
