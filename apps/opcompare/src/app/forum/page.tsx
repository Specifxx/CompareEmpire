...
export const metadata: Metadata = {
  title: `One Piece Buy & Sell Forum — ${SITE_NAME}`,
  description:
    "Community board for One Piece TCG players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
