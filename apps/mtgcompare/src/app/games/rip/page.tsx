...
export const metadata: Metadata = {
  title: "Pack Rip Simulator — Open Magic Packs for Free",
  description:
    "Rip simulated 10-card Magic: The Gathering packs from recent sets, flip each card to reveal real market values, and see if your pack beats the typical pack price. Free, no signup.",
