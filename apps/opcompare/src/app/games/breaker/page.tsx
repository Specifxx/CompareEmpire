...
export const metadata: Metadata = {
  title: "Bulk Breaker — breakout with real One Piece cards",
  description:
    "Breakout where the bricks are real One Piece cards — smash them to bank their live market value, catch multi-ball and wide-paddle power-ups, and clear levels of fresh cards.",
