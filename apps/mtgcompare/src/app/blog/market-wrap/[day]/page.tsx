...
export default async function MarketWrapDayPage({ params }: { params: { day: string } }) {
  ...
  const articleLd = {
    ...
    "@type": "Article",
    headline: `${wrap.headline} — MTGCompare Daily Market Wrap`,
    description: wrap.lede,
    datePublished: wrap.day,
    author: { "@type": "Organization", name: "MTGCompare", url: SITE_URL },
    publisher: { "@type": "Organization", name: "MTGCompare", url: SITE_URL },
  ...
  return (
    <article className="mx-auto max-w-3xl">
      ...
      <p className="mt-2 text-xs text-slate-500">
        {longDate(wrap.day)} · generated automatically from MTGCompare&apos;s daily store-price snapshots
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-ink-800 pt-4 text-sm">
        ...
        <Link href="/market" className="text-brand-400 hover:underline">Full MTGCompare Index →</Link>
      ...
      <p className="mt-6 text-[11px] leading-relaxed text-slate-600">
        Methodology: this report is generated automatically each day from MTGCompare&apos;s store-price snapshots —
