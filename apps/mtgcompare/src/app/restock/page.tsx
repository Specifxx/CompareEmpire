...
export const metadata: Metadata = {
  title: "Magic drops & restocks — new releases, preorders and restock alerts",
  description:
    "Every new and upcoming Magic: The Gathering release with the cheapest live preorder/stock across stores in Australia, New Zealand, the US and the UK — plus free restock alerts for sold-out sets.",
    ...
    <div className="mx-auto max-w-4xl">
      <header className="mb-6">
        ...
        <p className="mt-1 max-w-2xl text-slate-400">
          Every new and upcoming Magic release with the cheapest live {info.adjective} preorder or stock —
