      ...
      <div>
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Real top-finishing tournament decklists from the current Pokémon TCG metagame — each
      ...
      {beginner.length > 0 && (
        <div>
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-400">
              New to the Pokémon TCG? These budget-friendly decks are built mostly from cheap commons
