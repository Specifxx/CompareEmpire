...
// "yugioh card value" / "how much are my pokemon cards worth" / "price
...
export const metadata: Metadata = {
  title: "Yu-Gi-Oh! Card Value Checker — Free Price Guide (2026)",
  description:
    "Check what your Yu-Gi-Oh! cards are worth, free: search any card to see its live market value plus real store prices in Australia, New Zealand, the US and the UK. Vintage Base Set to the newest Mega Evolution chases — updated daily.",
  keywords: [
    "yugioh card value",
    "yugioh card value checker",
    "how much are my pokemon cards worth",
    "yugioh card price checker",
    "yugioh card worth",
    "yugioh card price guide",
  ],
...
const FAQS = [
  ...
  {
    q: "What makes a Yu-Gi-Oh! card valuable?",
  ...
  {
    q: "Is this Yu-Gi-Oh! card value checker free?",
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">Yu-Gi-Oh! card value — FAQ</h2>
