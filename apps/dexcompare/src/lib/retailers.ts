...
export const RETAILERS: Record<string, RetailerInfo> = {
  ...
  kingdomgaming: {
    key: "kingdomgaming",
    name: "Kingdom Gaming",
    base: "https://kingdomgaming.co.uk",
    collections: ["pokemon-singles-1", "pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 3000,
    shippingNote: "est. £1.50 · free over £30",
  ...
  pokemonsinglesuk: {
    key: "pokemonsinglesuk",
    name: "PokemonSingles.co.uk",
    base: "https://pokemonsingles.co.uk",
    collections: ["pokemon-singles", "pokemon"],
    shippingFlatCents: 120,
    freeOverCents: 2500,
    shippingNote: "est. £1.20 · free over £25",
...
const STORES_WITH_POLICY = new Set([
  ...
  "cardboardanddie", "ubecard", "galaxygames", "gamersgrove", "guardiangames",
  ...
  "cardrush", "gocardsuk", "kingdomgaming", "eternacards", "pokemonsinglesuk",
]);
