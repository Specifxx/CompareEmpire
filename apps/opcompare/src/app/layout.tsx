...
export const metadata: Metadata = {
  ...
  title: {
    default: "OPCompare — One Piece Card Game Card Database & Price Comparison",
    template: "%s — OPCompare",
  },
  description:
    "The One Piece Card Game card database and price comparison. Browse cards and compare live prices across stores in Australia, New Zealand, the United States and the United Kingdom to find the cheapest place to buy One Piece singles.",
  applicationName: SITE_NAME,
  keywords: ["One Piece the Gathering", "One Piece", "One Piece prices", "One Piece singles", "card prices", "One Piece card database", "One Piece card prices"],
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    url: SITE_URL,
    title: "OPCompare — One Piece Card Game Card Database & Price Comparison",
    description:
      "Compare live One Piece Card Game card prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
  },
  ...
  "@graph": [
    {
      ...
      "@id": `${SITE_URL}/#org`,
      name: SITE_NAME,
      alternateName: ["One Piece Compare", "OPCompare.app"],
      url: SITE_URL,
      logo: `${SITE_URL}/apple-icon`,
      description:
        "One Piece Card Game card database and live price-comparison across Australia, New Zealand, the US and the UK.",
    },
    {
      "@type": "WebSite",
      "@id": `${SITE_URL}/#website`,
      ...
      <body className="min-h-screen bg-ink-950">
        ...
        <footer className="container-app border-t border-ink-800 py-8 text-center text-xs text-slate-500">
          ...
          <p>
            ...
            site. Not affiliated with or endorsed by Bandai.
