...
// "Main Deck" folds the Pokémon/Trainer/Energy cards together; the underlying
// section keys stay flexible so any sourced list shape works.
const GROUPS: { title: string; sections: string[]; muted?: boolean }[] = [
  { title: "Featured", sections: ["champion", "legend", "featured"] },
  { title: "Pokémon", sections: ["pokemon", "unit"] },
  { title: "Trainers", sections: ["trainer", "gear", "spell", "supporter", "item", "stadium"] },
  { title: "Energy", sections: ["energy", "rune", "battlefield"] },
