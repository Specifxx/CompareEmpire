  ...
  theme: {
    extend: {
      colors: {
        ...
        // Magic-inspired: deep mana blue accent + warm gold for prices.
        brand: {
          DEFAULT: "#2563eb",
          400: "#60a5fa",
          500: "#3b82f6",
        ...
        accent: "#f5b301", // warm gold — prices & highlights
        gold: "#ffd23f",
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px rgba(37,99,235,0.25), 0 10px 30px rgba(245,179,1,0.18)",
      },
      keyframes: {
        "fade-up": {
