...
export const metadata: Metadata = {
  title: "Daily Market Wrap — how the Magic card market moved",
  description:
    "An automated daily report on the Magic singles market: the MTGCompare Global Index move, every market's day, and the cards that drove it — generated from real store-price snapshots.",
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="mt-1 font-display text-3xl font-extrabold text-white">
        The Magic market, every day
      </h1>
      <p className="mt-3 text-sm leading-relaxed text-slate-300">
        An automated daily report built from MTGCompare&apos;s store-price snapshots: the Global Index
