...
export const metadata: Metadata = {
  title: "camera Buy & Sell Forum — CameraCompare",
  description:
    "Community board for cameras players to post want-to-buy (WTB) and want-to-sell (WTS) listings and trade cards directly with others in your country.",
