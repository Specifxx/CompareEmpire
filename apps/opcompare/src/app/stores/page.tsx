...
export const metadata: Metadata = {
  title: "Stores we track — every One Piece retailer in the comparison",
  description:
    "The full list of One Piece Card Game stores OPCompare compares prices across, by market (Australia, the US and the UK). Don't see your store? Request it.",
...
const FAQS = [
  {
    q: "How often are One Piece card prices updated?",
  ...
  {
    q: "Does OPCompare include postage in the price comparison?",
  ...
  {
    q: "Which countries does OPCompare cover?",
    a: "OPCompare currently covers Australia, the United States, and the United Kingdom. Each market shows prices in its local currency (AUD, USD, GBP) from retailers that actually ship to buyers in that region. Switch markets using the country selector in the navigation.",
  },
  {
    q: "Can I trust the prices shown on OPCompare?",
    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-400">
          OPCompare compares live prices across {total} One Piece retailers plus eBay, grouped by
      ...
      <section className="card-surface p-6 text-center">
        ...
        <p className="mx-auto mt-1 max-w-xl text-sm text-slate-400">
          We&apos;re always adding retailers. If there&apos;s a One Piece store you&apos;d like compared, send us the
