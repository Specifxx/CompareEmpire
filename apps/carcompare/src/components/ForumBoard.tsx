    ...
    <div>
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Buy, sell and talk car with other players in {myCountryName}. List several cards in one
      ...
      <div className="mb-5 flex items-start gap-3 rounded-xl border border-ink-700 bg-ink-900/60 p-3.5">
        ...
        <p className="text-xs leading-relaxed text-slate-400">
          ...
          tracked payment and postage. CarCompare is not a party to any trade between members.
        </p>
      </div>
      ...
      <p className="mt-6 text-center text-[11px] text-slate-600">
        CarCompare hosts these community listings but is not a party to any trade. Deal carefully and meet/pay safely.
      </p>
