...
export const metadata: Metadata = {
  title: "All Magic: The Gathering Sets",
  description: "Browse every Magic: The Gathering set and compare card prices set by set.",
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-1 flex items-end justify-between gap-3">
        <h1 className="text-2xl font-extrabold text-white">All Magic: The Gathering sets</h1>
