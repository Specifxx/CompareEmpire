...
// /most-valuable share card — previously fell back to the generic site-wide
...
export const alt = "Most Valuable Pokémon Cards, Ranked — DexCompare";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ fontSize: 26, color: "#94a3b8", display: "flex", marginTop: 18 }}>
            {["ranked by live price", "vintage holos & alt arts", "updated daily"].join(" · ")}
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 24, color: "#64748b", display: "flex" }}>
            AU · NZ · US · UK, every store we track
          </div>
