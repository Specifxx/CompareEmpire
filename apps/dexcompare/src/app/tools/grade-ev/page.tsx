...
export const metadata: Metadata = {
  title: { absolute: "Should I Grade This Pokémon Card? — Free Grade-or-Not Calculator | DexCompare" },
  description:
    "Free calculator: is it worth grading your Pokémon card? Enter the raw value, your gem-mint odds and grading tier to see the expected value graded vs sold raw — a clear grade / don't-grade verdict.",
  ...
  keywords: [
    ...
    "pokemon card grading value",
    "grade or not calculator",
  ],
  openGraph: {
    title: "Should I Grade This Pokémon Card?",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is it worth grading a Pokémon card?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "What is the 3× rule for grading Pokémon cards?",
                acceptedAnswer: {
                  "@type": "Answer",
