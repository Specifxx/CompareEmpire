// Parser for pasted Pokémon decklists (TCGplayer Mass Entry style + variants).
// Each entry line looks like:
//   3 Charizard ex
//   3x Charizard ex (OBF-125)
//   1 OBF-125
...
export function parseDeckList(text: string): ParsedLine[] {
  ...
  for (const rawLine of text.split(/\r?\n/)) {
    ...
    // Pull out a set-number token like (OBF-125), OBF-125 or SVI 039a.
