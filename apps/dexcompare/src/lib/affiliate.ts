...
const EBAY_MARKETS: Record<string, { mkrid: string; siteid: string; customid: string }> = {
  "ebay.com.au": { mkrid: "705-53470-19255-0", siteid: "15", customid: "dex-au" },
  "ebay.com": { mkrid: "711-53200-19255-0", siteid: "0", customid: "dex-us" },
  "ebay.co.uk": { mkrid: "710-53481-19255-0", siteid: "3", customid: "dex-uk" },
};
