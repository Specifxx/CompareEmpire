...
export const metadata: Metadata = {
  title: "camera Top Meta Decks & Build Cost (Australia)",
  description:
    "Ready-made camera decklists, each priced live across Australian stores. See what it costs to build a deck and where to buy every card.",
      ...
      {beginner.length > 0 && (
        <div>
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-400">
              New to camera? These budget-friendly decks are built mostly from cheap commons
