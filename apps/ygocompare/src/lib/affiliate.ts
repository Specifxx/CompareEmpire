...
export const AMAZON_ASSOCIATE_TAG = process.env.AMAZON_ASSOCIATE_TAG || "ygocompare-20";
...
const EBAY_MARKETS: Record<string, { mkrid: string; siteid: string; customid: string }> = {
  "ebay.com.au": { mkrid: "705-53470-19255-0", siteid: "15", customid: "ygo-au" },
  "ebay.com": { mkrid: "711-53200-19255-0", siteid: "0", customid: "ygo-us" },
  "ebay.co.uk": { mkrid: "710-53481-19255-0", siteid: "3", customid: "ygo-uk" },
};
...
const NEVER_WRAP = /(?:^|\.)(ygocompare.app|riftcompare\.com|ebay\.|amazon\.|tcgplayer\.com)$/i;
...
export function affiliateUrl(url: string | null | undefined, subId = "ygocompare"): string {
  if (!url) return "#";
  try {
    const u = new URL(url);
