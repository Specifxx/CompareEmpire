...
export function generateMetadata({ searchParams }: { searchParams: CardQuery }): Metadata {
  ...
  return {
    title: "Browse the Magic card database",
    description:
      "Search and filter every Magic: The Gathering card and compare live prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
