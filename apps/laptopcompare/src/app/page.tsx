...
export const metadata: Metadata = {
  title: { absolute: "Compare Laptop Prices | LaptopCompare" },
  description:
    "Compare live laptop prices across stores in Australia, the US and the UK, and find the cheapest place to buy your next mirrorless, DSLR or compact laptop. Updated daily.",
  keywords: [
    "buy laptops",
    "laptop prices",
    "compare laptop prices",
    "cheapest laptops",
    "mirrorless laptop deals",
    "DSLR prices",
...
function faqsFor(info: CountryInfo, ebay: string | null): { q: string; a: string }[] {
  ...
  return [
    {
      q: `Where can I buy laptops in ${place}?`,
      a: `LaptopCompare compares live laptop prices across a wide range of ${adjective} stores${ebay ? ` plus ${ebay}` : ""}, so you can buy from whichever shop is cheapest. Search any laptop to see every store's price and click straight through to buy.`,
    },
    {
      q: `How do I find the cheapest laptop prices in ${place}?`,
      a: `Search or browse the laptop database and each laptop shows the lowest live price across ${adjective} stores, ranked by total delivered cost (item plus shipping). It's the fastest way to find the cheapest laptops in ${place}.`,
    },
    {
      q: "What laptops does LaptopCompare cover?",
      a: `We compare prices on mirrorless laptops, DSLRs, compacts, action laptops and lenses from the major brands, all priced across ${adjective} retailers.`,
    },
    {
      q: `Are the laptop prices shown in ${currency}?`,
    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface animate-fade-up overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-12 text-center">
          ...
          <h1 className="mx-auto max-w-3xl text-2xl font-extrabold text-white sm:text-4xl">
            Compare laptop prices across {info.adjective} stores
          </h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-400 sm:text-base">
            Find the cheapest place to buy your next laptop in {info.place} — live prices in{" "}
            {info.currency} compared across {storeCount} {info.adjective} stores, updated daily.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link href="/browse" className="btn-primary">Browse laptops</Link>
          </div>
          ...
          <div className="mx-auto mt-8 grid max-w-lg grid-cols-3 gap-4">
            <Stat value={totalCards.toLocaleString()} label="laptops" />
      ...
      <section>
        <div className="mb-4 flex items-end justify-between gap-3">
          <div>
            <h2 className="text-xl font-extrabold text-white">Cheapest laptops</h2>
            <p className="mt-0.5 text-xs text-slate-500">
              The lowest live prices right now — we check {storeCount} {info.adjective} stores for every laptop so you always pay the least.
            </p>
          </div>
      ...
      {/* Browse by sensor */}
      <section>
        <h2 className="mb-4 text-xl font-extrabold text-white">Browse by screen size</h2>
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">Laptop prices in {info.place}, all in one place</h2>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-400">
          LaptopCompare is a free, independent price-comparison tool for laptops, built for
          {" "}{info.adjective} buyers. We track live prices for mirrorless bodies, DSLRs, compacts,
          action laptops and lenses across {info.adjective} stores{ebay ? ` and ${ebay}` : ""} so you
          can buy your next laptop in {info.place} for less.
        </p>
