...
export const metadata: Metadata = {
  ...
  description: "Browse every One Piece Card Game set and compare card prices set by set.",
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-1 flex items-end justify-between gap-3">
        <h1 className="text-2xl font-extrabold text-white">All One Piece Card Game sets</h1>
