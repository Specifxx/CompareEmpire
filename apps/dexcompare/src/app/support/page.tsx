...
export const metadata: Metadata = {
  title: "Support & Help Center — DexCompare",
  description: "Get help with DexCompare — how prices work, how to report an issue, and where to go for buying guides and account help.",
...
const TOPICS = [
  {
    ...
    links: [
      { href: "/guides/why-pokemon-card-prices-differ-between-stores", label: "Why prices differ between stores" },
  ...
  },
  {
    ...
    links: [{ href: "/learn", label: "Learn Pokémon TCG collecting →" }],
  },
  {
