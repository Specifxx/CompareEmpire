...
export const metadata: Metadata = {
  ...
  title: {
    default: "CarCompare — Car Database & Price Comparison",
    template: "%s — CarCompare",
  },
  description:
    "The car database and price comparison. Browse cars and compare live prices across stores in Australia, the United States and the United Kingdom to find the cheapest place to buy.",
  applicationName: SITE_NAME,
  keywords: ["car", "cars", "car prices", "mirrorless car", "DSLR", "buy car"],
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    siteName: SITE_NAME,
    url: SITE_URL,
    title: "CarCompare — Car Database & Price Comparison",
    description:
      "Compare live car prices across stores in Australia, the US and the UK to find the cheapest place to buy.",
  },
  ...
  "@graph": [
    {
      ...
      "@id": `${SITE_URL}/#org`,
      name: SITE_NAME,
      alternateName: ["Car Compare", "CarCompare.com"],
      url: SITE_URL,
      logo: `${SITE_URL}/icon-512.png`,
      description:
        "Car database and live price-comparison across Australia, the US and the UK.",
    },
    {
      "@type": "WebSite",
      "@id": `${SITE_URL}/#website`,
    ...
    <html lang="en-AU" className={`${sora.variable} ${spaceGrotesk.variable}`}>
      ...
      <body className="min-h-screen bg-ink-950">
        ...
        <footer className="container-app border-t border-ink-800 py-8 text-center text-xs text-slate-500">
          ...
          <p>
            CarCompare · car database &amp; price comparison for
