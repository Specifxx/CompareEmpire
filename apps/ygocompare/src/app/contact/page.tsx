...
export const metadata = {
  title: "Contact & Feedback — YGOCompare",
  description: "Get in touch with YGOCompare — report a price issue, suggest a store to add, or send feedback.",
      ...
      <div className="card-surface overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-10 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-300">
            Spotted a wrong price, a missing store, or have an idea to make YGOCompare better?
            We&apos;d genuinely love to hear from you — just send us an email.
          </p>

          <a
            href={`mailto:${CONTACT_EMAIL}?subject=YGOCompare%20feedback`}
