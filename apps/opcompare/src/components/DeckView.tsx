...
// Decklist display groups, in order. The featured card (Leader) is shown above.
// "Main Deck" folds the Character/Event/Stage cards together; the underlying
// section keys stay flexible so any sourced list shape works.
const GROUPS: { title: string; sections: string[]; muted?: boolean }[] = [
  { title: "Featured", sections: ["champion", "legend", "featured", "leader"] },
  { title: "Characters", sections: ["character", "unit", "pokemon"] },
  { title: "Events", sections: ["event", "gear", "spell", "supporter", "item", "trainer"] },
  { title: "Stages", sections: ["stage", "stadium", "rune", "battlefield", "energy"] },
