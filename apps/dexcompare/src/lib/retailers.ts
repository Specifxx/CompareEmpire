...
export const RETAILERS: Record<string, RetailerInfo> = {
  ...
  dexterscardhouse: {
    key: "dexterscardhouse",
    name: "Dexters Card House",
    base: "https://dexterscardhouse.co.uk",
    collections: ["pokemon-singles", "pokemon"],
    shippingFlatCents: 150,
    freeOverCents: 3000,
    shippingNote: "est. £1.50 · free over £30",
...
const STORES_WITH_POLICY = new Set([
  ...
  "tcgtemple", "headsortails",
  "titancards", "totalcards", "pokephd", "dicesaloon", "bossminis",
  "cardgoblin", "doublesleeved", "lvlupgaming", "collectbydesign", "collecteebles",
  "wishlistcollectables", "thecardvault", "pixelhub", "jarvvos", "koolthings",
  "cardrush", "gocardsuk", "dexterscardhouse",
]);
