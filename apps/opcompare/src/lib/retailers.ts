...
export interface RetailerInfo {
  ...
  collections: string[]; // Shopify collection handles holding One Piece singles
...
export const RETAILERS: Record<string, RetailerInfo> = {
  ...
  // Additional Australian One Piece stores. Collections are auto-discovered from each
  // store's Shopify sitemap (One Piece-singles handles), so only the domain is needed.
  collectiblemadness: {
  ...
  // More local Australian One Piece singles stores (Shopify; collections auto-discovered
  ...
  // Additional US One Piece Shopify stores (collections auto-discovered from each
  ...
  // Additional US One Piece Shopify stores (round 2). Domains verified Shopify via
  // /collections paths or .myshopify.com; collections auto-discovered from each
  // store's sitemap, with a One Piece-singles handle as fallback. Each is validated
  ...
  // sitemap, with an explicit One Piece-singles handle as a fallback. Shipping figures
  // are GBP estimates.
  titancards: {
    key: "titancards",
    name: "Titan Cards",
  ...
  // Additional UK One Piece Shopify stores (round 2). Each validated by
