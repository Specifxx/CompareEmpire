...
export const metadata: Metadata = {
  title: "Card Catcher — the Magic card arcade game",
  description:
    "Catch falling Magic cards and bank their real market value — dodge the fakes, ride the combo, grab gold ×2 and slow-mo power-ups. A free arcade game built on live card prices.",
