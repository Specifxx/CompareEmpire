      ...
      <div className="lg:sticky lg:top-20 lg:self-start">
        <div className="card-surface p-4">
          ...
          <p className="mb-2 text-xs text-slate-500">
            ...
            <span className="font-mono">4 Charizard ex</span>. Set codes like{" "}
            <span className="font-mono">(OBF-125)</span> are optional. (TCGplayer Mass Entry format.)
          </p>
          <textarea
            value={text}
