...
export const RETAILERS: Record<string, RetailerInfo> = {
  ...
  // ── Additional Pokémon stores (community-added) ──────────────────────────────
  ...
  gapgames: {
    key: "gapgames",
    name: "GAP Games",
    base: "https://www.gapgames.com.au",
    collections: ["pokemon-singles", "pokemon"],
    shippingFlatCents: 599,
    freeOverCents: 15000,
    shippingNote: "est. $5.99 tracked",
  },
  hobbymaster: {
    key: "hobbymaster",
    name: "Hobbymaster",
    base: "https://www.hobbymaster.com.au",
    collections: ["pokemon-singles", "pokemon"],
