...
// dynamic); the country only affects which creative/eBay domain the banners
// use, so it now comes from the client country context — worst case a
// pre-hydration frame shows the AU-default creative.
