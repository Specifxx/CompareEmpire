...
export const RETAILERS: Record<string, RetailerInfo> = {
  ...
  ironlion: {
    ...
    base: "https://ironlioncollectibles.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 5000,
    shippingNote: "est. US$1.50 · free over US$50",
  ...
  unpluggedgames: {
    key: "unpluggedgames",
    name: "Unplugged Game Store",
    base: "https://unpluggedgamestore.com",
    collections: ["pokemoncards", "pokemon-singles"],
    shippingFlatCents: 200,
    freeOverCents: 5000,
    shippingNote: "est. US$2.00 · free over US$50",
    country: "US",
  ...
  pokemongcc: {
    key: "pokemongcc",
    name: "Pokemon GCC",
    base: "https://pokemongcc.myshopify.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 5000,
    shippingNote: "est. US$1.50 · free over US$50",
  ...
  pokecourt: {
    key: "pokecourt",
    name: "The Trainer Court",
    base: "https://thepokecourt.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 5000,
    shippingNote: "est. US$1.50 · free over US$50",
  ...
  lasvegaspokemon: {
    key: "lasvegaspokemon",
    name: "Vegas CardXChange",
    base: "https://lasvegaspokemon.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 5000,
    shippingNote: "est. US$1.50 · free over US$50",
  ...
  commandergames: {
    key: "commandergames",
    name: "Commander Games LV",
    base: "https://commandergameslv.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 200,
    freeOverCents: 5000,
    shippingNote: "est. US$2.00 · free over US$50",
  ...
  hithub: {
    key: "hithub",
    name: "HitHub",
    base: "https://hithub.co.uk",
    collections: ["pokemon-singles"],
    shippingFlatCents: 120,
    freeOverCents: 1500,
    shippingNote: "est. £1.20 · free over £15",
    country: "GB",
  },
  wishlistcollectables: {
    key: "wishlistcollectables",
    name: "Wishlist Collectables",
    base: "https://www.wishlistcollectables.co.uk",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 3000,
    shippingNote: "est. £1.50 · free over £30",
  ...
  retroble: {
    key: "retroble",
    name: "RETROBLE",
    base: "https://retroble.myshopify.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 120,
    freeOverCents: 2500,
    shippingNote: "est. £1.20 · free over £25",
  ...
  koolthings: {
    key: "koolthings",
    name: "KoolThings",
    base: "https://www.koolthings.co.uk",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 3000,
    shippingNote: "est. £1.50 · free over £30",
  ...
  ukpokemon: {
    key: "ukpokemon",
    name: "UK Pokemon",
    base: "https://uk-pokemon.myshopify.com",
    collections: ["pokemon-singles"],
    shippingFlatCents: 150,
    freeOverCents: 3000,
    shippingNote: "est. £1.50 · free over £30",
...
const STORES_WITH_POLICY = new Set([
  ...
  "mulliganmerchant", "mostexcellent", "ironlion", "onestoptcg", "unpluggedgames", "vegassingles",
  "tcgtemple", "pokemongcc", "pokecourt", "headsortails", "lasvegaspokemon", "commandergames",
  "titancards", "totalcards", "pokephd", "dicesaloon", "bossminis",
  "cardgoblin", "doublesleeved", "lvlupgaming", "collectbydesign", "collecteebles", "hithub",
  "wishlistcollectables", "thecardvault", "retroble", "pixelhub", "jarvvos", "koolthings", "ukpokemon",
]);
