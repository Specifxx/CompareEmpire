...
export const metadata: Metadata = {
  title: "Browse Pokémon Cards by Type, Rarity & Era — DexCompare",
  description: "Every way to browse the Pokémon TCG price database on DexCompare — by card type, rarity, printing and era.",
  alternates: { canonical: "/cards" },
  openGraph: { title: "Browse Pokémon Cards", url: `${SITE_URL}/cards` },
};
...
export default async function CardsIndexPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        <h1 className="text-2xl font-extrabold text-white sm:text-3xl">Browse Pokémon cards</h1>
