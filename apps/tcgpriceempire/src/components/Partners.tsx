...
// Trust strip: the partner programs TCGPriceEmpire is APPROVED for — shown as a
// credibility signal. Honest framing ("approved affiliate partners"); wordmarks
// are styled text — no third-party logo assets are copied.
export function Partners() {
  const ebayHref = ebaySearchUrl("trading card game");
  const tcgHref = affiliateUrl("https://www.tcgplayer.com/");
  return (
