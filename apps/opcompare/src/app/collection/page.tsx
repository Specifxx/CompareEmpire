...
export const metadata: Metadata = {
  title: "My Collection — track your One Piece cards & portfolio value",
  description:
    "Track the One Piece cards you own, see your collection's live market value across stores, and watch your set completion grow.",
