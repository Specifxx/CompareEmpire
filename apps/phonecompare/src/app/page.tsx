...
export const metadata: Metadata = {
  title: { absolute: "Compare Phone Prices | PhoneCompare" },
  description:
    "Compare live phone prices across stores in Australia, the US and the UK, and find the cheapest place to buy your next mirrorless, DSLR or compact phone. Updated daily.",
  keywords: [
    "buy phones",
    "phone prices",
    "compare phone prices",
    "cheapest phones",
    "mirrorless phone deals",
    "DSLR prices",
...
function faqsFor(info: CountryInfo, ebay: string | null): { q: string; a: string }[] {
  ...
  return [
    {
      q: `Where can I buy phones in ${place}?`,
      a: `PhoneCompare compares live phone prices across a wide range of ${adjective} stores${ebay ? ` plus ${ebay}` : ""}, so you can buy from whichever shop is cheapest. Search any phone to see every store's price and click straight through to buy.`,
    },
    {
      q: `How do I find the cheapest phone prices in ${place}?`,
      a: `Search or browse the phone database and each phone shows the lowest live price across ${adjective} stores, ranked by total delivered cost (item plus shipping). It's the fastest way to find the cheapest phones in ${place}.`,
    },
    {
      q: "What phones does PhoneCompare cover?",
      a: `We compare prices on mirrorless phones, DSLRs, compacts, action phones and lenses from the major brands, all priced across ${adjective} retailers.`,
    },
    {
      q: `Are the phone prices shown in ${currency}?`,
    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="card-surface animate-fade-up overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-12 text-center">
          ...
          <h1 className="mx-auto max-w-3xl text-2xl font-extrabold text-white sm:text-4xl">
            Compare phone prices across {info.adjective} stores
          </h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-400 sm:text-base">
            Find the cheapest place to buy your next phone in {info.place} — live prices in{" "}
            {info.currency} compared across {storeCount} {info.adjective} stores, updated daily.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link href="/browse" className="btn-primary">Browse phones</Link>
          </div>
          ...
          <div className="mx-auto mt-8 grid max-w-lg grid-cols-3 gap-4">
            <Stat value={totalCards.toLocaleString()} label="phones" />
      ...
      <section>
        <div className="mb-4 flex items-end justify-between gap-3">
          <div>
            <h2 className="text-xl font-extrabold text-white">Cheapest phones</h2>
            <p className="mt-0.5 text-xs text-slate-500">
              The lowest live prices right now — we check {storeCount} {info.adjective} stores for every phone so you always pay the least.
            </p>
          </div>
      ...
      {/* Browse by sensor */}
      <section>
        <h2 className="mb-4 text-xl font-extrabold text-white">Browse by form factor</h2>
      ...
      <section className="card-surface p-6">
        <h2 className="text-xl font-extrabold text-white">Phone prices in {info.place}, all in one place</h2>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-400">
          PhoneCompare is a free, independent price-comparison tool for phones, built for
          {" "}{info.adjective} buyers. We track live prices for mirrorless bodies, DSLRs, compacts,
          action phones and lenses across {info.adjective} stores{ebay ? ` and ${ebay}` : ""} so you
          can buy your next phone in {info.place} for less.
        </p>
