...
export const metadata: Metadata = {
  title: "Best Basket — Cheapest Way to Buy Your Whole Wishlist | DexCompare",
  description:
    "Price your entire Pokémon card wishlist at once: see the cheapest single store, or the cheapest split across stores, so you know exactly what you'd pay before checking out.",
