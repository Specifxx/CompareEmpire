...
export function generateMetadata({ searchParams }: { searchParams: { q?: string; type?: string } }): Metadata {
  ...
  return {
    title: "Yu-Gi-Oh! booster packs, boxes & ETBs — compare sealed prices",
    description:
      "Browse the full Yu-Gi-Oh! sealed-product database — booster packs, booster boxes, elite trainer boxes, bundles, collection boxes and tins — and compare live prices across stores in Australia, New Zealand, the US and the UK to find the cheapest place to buy.",
    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="card-surface overflow-hidden">
        <div className="relative bg-gradient-to-br from-brand-600/25 via-ink-850 to-gold/15 px-6 py-8">
          <h1 className="text-2xl font-extrabold text-white sm:text-3xl">Yu-Gi-Oh! sealed products</h1>
