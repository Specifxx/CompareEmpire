// Parser for pasted One Piece decklists (TCGplayer Mass Entry style + variants).
// Each entry line looks like:
//   4 Monkey D. Luffy
//   4x Monkey D. Luffy (OP01-003)
//   1 OP01-003
...
export function parseDeckList(text: string): ParsedLine[] {
  ...
  for (const rawLine of text.split(/\r?\n/)) {
    ...
    // Pull out a set-number token like (OP01-003), OP01-003 or ST01 003a.
