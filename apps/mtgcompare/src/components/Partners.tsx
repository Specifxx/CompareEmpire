...
// Trust strip: the partner programs MTGCompare is APPROVED for — shown as a
...
export function Partners({ country }: { country: string }) {
  const ebayHref = ebaySearchUrl("magic cards", country);
  const tcgHref = affiliateUrl("https://www.tcgplayer.com/search/magic/product");
  return (
