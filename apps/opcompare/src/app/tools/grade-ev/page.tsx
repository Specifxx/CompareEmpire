...
export const metadata: Metadata = {
  title: { absolute: "Should I Grade This One Piece Card? — Free Grade-or-Not Calculator | OPCompare" },
  description:
    "Free calculator: is it worth grading your One Piece card? Enter the raw value, your gem-mint odds and grading tier to see the expected value graded vs sold raw — a clear grade / don't-grade verdict.",
  alternates: { canonical: "/tools/grade-ev" },
  keywords: [
    "should i grade my one piece card",
    "is it worth grading one piece cards",
    "psa grading worth it calculator",
    "one piece card grading value",
    "grade or not calculator",
  ],
  openGraph: {
    title: "Should I Grade This One Piece Card?",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is it worth grading a One Piece card?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Grading is worth it when the expected graded value — your chance of a 10 times the PSA-10 price, plus partial credit for a 9 — exceeds the raw price by more than the grading cost (roughly US$19–75 per card). For most cards under about US$20 raw, it isn't.",
                },
              },
              {
                "@type": "Question",
                name: "What is the 3× rule for grading One Piece cards?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A common collector heuristic: only grade if a PSA-10 copy sells for at least three times the raw price. It's a rough safety margin that covers the grading fee plus the risk of getting a 9 instead of a 10.",
                },
              },
            ],
          }),
