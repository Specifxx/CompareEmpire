  ...
  theme: {
    extend: {
      colors: {
        ...
        // Automotive vibe: electric-blue accent over cool slate surfaces.
        brand: {
          DEFAULT: "#2563eb",
          400: "#60a5fa",
          500: "#3b82f6",
        ...
        accent: "#38bdf8", // sky blue — prices & highlights
        gold: "#7dd3fc",
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px rgba(37,99,235,0.25), 0 10px 30px rgba(56,189,248,0.16)",
      },
      keyframes: {
        "fade-up": {
