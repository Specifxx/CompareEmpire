    ...
    <div className="card-surface p-6 text-center">
      ...
      {state === "ok" && (
        <>
          ...
          <p className="mt-1 text-sm text-slate-400">Your LaptopCompare email is verified.</p>
          <Link href="/" className="btn-primary mt-4 inline-flex">Go to LaptopCompare</Link>
        </>
      )}
      {state === "error" && (
        <>
