...
// abuse (email-bombing the alert endpoint, hammering the roast endpoint), but it
// is NOT a hard global cap. For strict global limits, back this with Upstash Redis
// (@upstash/ratelimit) or configure Vercel Firewall rate-limit rules in front.
