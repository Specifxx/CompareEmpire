...
export const metadata: Metadata = {
  title: { absolute: "The YGOCompare Index — Yu-Gi-Oh! Card Market Tracker | YGOCompare" },
  description:
    "One number for the health of the Yu-Gi-Oh! singles market. The YGOCompare Index tracks the most valuable cards as a daily base-100 index per market, with a global composite, breadth, movers and sealed supply. Updated daily, free to cite.",
...
export default async function MarketPage({ searchParams }: { searchParams: { scope?: string } }) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "YGOCompare Index", item: `${SITE_URL}/market` },
    ],
  };
  const datasetLd = startDay
    ? {
        "@context": "https://schema.org",
        "@type": "Dataset",
        name: "The YGOCompare Index",
        description: `Daily base-100 price index of the ${data.basketSize} most valuable Yu-Gi-Oh! cards per market, from live store prices. Base 100 on ${startDay}.`,
        url: `${SITE_URL}/market`,
        creator: { "@type": "Organization", name: "YGOCompare", url: SITE_URL },
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <nav className="mb-3 flex items-center gap-1.5 text-xs text-slate-500" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-slate-300">YGOCompare Index</span>
      </nav>

      <header className="mb-5">
        <h1 className="font-display text-3xl font-extrabold text-white">📈 The YGOCompare Index</h1>
        <p className="mt-1 max-w-2xl text-slate-400">
          The Yu-Gi-Oh! singles market in one number: a base-100 index of the {data.basketSize || "top"} most
      ...
      <section id="cite" className="card-surface mt-8 space-y-3 p-5 text-sm leading-relaxed text-slate-400">
        ...
        <p>
          The YGOCompare Index tracks what the {data.basketSize || "top"} most valuable in-scope Yu-Gi-Oh!
        ...
        <p className="text-slate-300">
          ...
          &ldquo;the YGOCompare Index&rdquo; with a link to this page. The{" "}
